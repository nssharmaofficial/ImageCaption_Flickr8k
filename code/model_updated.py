...
if __name__ == '__main__':
    ...
    # suppose captions have SEQ_LENGTH = 10 (second dimension)
    ...
    print('Features size: ', features.size()) # (SEQ_LENGTH, BATCH, IMAGE_EMD_DIM)
    ...
    print('Embedded captions size: ', embedded_captions.size()) # (SEQ_LENGTH, BATCH, WORD_EMB_DIM)
    ...
    print('Output size: ', output.size())       # (SEQ_LENGTH, BATCH, VOCAB_SIZE)
